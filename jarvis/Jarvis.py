...
speak('Hello mihir, I am your personal assistant!')
...
def myCommand():
    ...
    try:
        ...
        speak('Sorry mihir! I didn\'t get that! Try typing the command!')
        ...
        if 'open youtube' in query:
            ...
            if 'I am' in sender:
                try:
                    ...
                    speak('Sorry mihir! I am unable to send your message at this moment!')


        elif 'nothing' in query or 'abort' in query or 'stop' in query:
            speak('okay')
            speak('Bye mihir, have a good day.')
            sys.exit()
